...
class S3DIS(Dataset):
    ...
    class2color = {'ceiling':     [218,178,100],   # [0, 255, 0]
                   'floor':       [70,120,120],     # [0, 0, 255]
                   'wall':        [139,71,38],   # [0, 255, 255]
                   'beam':        [248,127,95],# [255, 255, 0]
                   'column':      [15,252,222],# [255, 0, 255]
                   'window':      [179,238,58],# [100, 100, 255]
                   'door':        [0,245,45],# [200, 200, 100]
                   'table':       [0, 176, 238],# [170, 120, 200]
                   'chair':       [255, 0, 0],# [255, 0, 0]
                   'sofa':        [225,129,235],# [200, 100, 100]
                   'bookcase':    [70,130,180],# [10, 200, 100]
                   'board':       [255,228,225],#  [200, 200, 200]
                   'clutter':     [104,50,90]}# [50, 50, 50]
